    ...
    public class CGAreaTrigger_C
    {
        public class OverrideScaleCurve : UpdateFieldStructure
        {
            ...
            public class OverrideScaleCurveFloat : UpdateFieldStructure
            {
                ...
                public OverrideScaleCurveFloat(int requiredCreationFlag, int updateBit, int fieldNum) : base(requiredCreationFlag, updateBit, fieldNum) { }
            }
            [UFArray(2)]
            public OverrideScaleCurveFloat AREATRIGGER_OVERRIDE_SCALE_CURVE_FLOATS = new OverrideScaleCurveFloat(0x0, 4, 0);
            ...
            public OverrideScaleCurve(int requiredCreationFlag, int updateBit, int fieldNum) : base(requiredCreationFlag, updateBit, fieldNum) { }
        }
        public OverrideScaleCurve AREATRIGGER_OVERRIDE_SCALE_CURVE = new OverrideScaleCurve(0x0, 1, 7);
        ...
        public class ExtraScaleCurve : UpdateFieldStructure
        {
            ...
            public class ExtraScaleCurveFloat : UpdateFieldStructure
            {
                ...
                public ExtraScaleCurveFloat(int requiredCreationFlag, int updateBit, int fieldNum) : base(requiredCreationFlag, updateBit, fieldNum) { }
            }
            [UFArray(2)]
            public ExtraScaleCurveFloat AREATRIGGER_EXTRA_SCALE_CURVE_FLOATS = new ExtraScaleCurveFloat(0x0, 4, 0);
            ...
            public ExtraScaleCurve(int requiredCreationFlag, int updateBit, int fieldNum) : base(requiredCreationFlag, updateBit, fieldNum) { }
        }
        public ExtraScaleCurve AREATRIGGER_EXTRA_SCALE_CURVE = new ExtraScaleCurve(0x0, 2, 7);
    }
}
